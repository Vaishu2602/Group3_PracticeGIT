...
public class S6_069_EditLeads {
	
	@Test
	
	public void s6_069_EditLeads() throws InterruptedException {
...
//			Click View All and click Sales from App Launcher 
		...
		// Click on the Leads tab
				...
				//Select Lead Status as 'Working-Contacted'
				Thread.sleep(2000);
				driver.executeScript("arguments[0].scrollIntoView(true)", driver.findElement(By.xpath(".//label[text()='Rating']")));
				Thread.sleep(2000);
				WebElement LeadStatusDropdown = driver.findElement(By.xpath(".//label[text()='Lead Status']//following::button[@aria-label='Lead Status']"));
				driver.executeScript("arguments[0].click()", LeadStatusDropdown);
				Thread.sleep(2000);
				driver.findElement(By.xpath("//label[text()='Lead Status']//following::span[@title='Working - Contacted']")).click();
				Thread.sleep(2000);
				//click Save and Verify Leads Name 
				Thread.sleep(2000);
				driver.findElement(By.xpath("(//button[text()='Save'])[2]")).click();
				Thread.sleep(5000);
				boolean LeadCreatedMsg = driver.findElement(By.xpath("//div[contains(@id,'toastDescription')]")).isDisplayed();
				Assert.assertTrue(LeadCreatedMsg);
				System.out.println(driver.findElement(By.xpath("//div[contains(@id,'toastDescription')]")).getText());
